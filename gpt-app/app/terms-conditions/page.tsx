    ...
    <div className="min-h-screen h-full bg-white text-slate-900 font-sans overflow-y-auto">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 mb-20">
        ...
        <div className="space-y-8 leading-relaxed text-lg text-slate-800">
          <p>
            These Terms and Conditions ("Terms") govern your use of the GPTiti service ("Service") operated by Your Price Booking OÜ.
          </p>
          ...
          <section>
            ...
            <div className="space-y-1">
              ...
              <p>Registered address: Harju maakond, Tallinn, Kesklinna linnaosa, Narva mnt 5, 10117, Estonia</p>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-slate-900">3. Eligibility</h2>
            <p>You must be at least 13 years old (or the minimum age required in your country) to use the Service.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4 text-slate-900">4. Account Registration</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-slate-900">5. Tokens and Payments</h2>
            <ul className="list-disc ml-6 space-y-2">
              ...
              <li>Token transfer between users may be introduced in the future.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4 text-slate-900">6. Use of the Service</h2>
            ...
            <p className="mt-4">Content generation is subject to limitations imposed by third-party AI providers.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4 text-slate-900">7. AI Risks and Disclaimer</h2>
            <p>The Service relies on third-party artificial intelligence systems.</p>
            ...
            <ul className="list-disc ml-6 space-y-2 mt-2">
              ...
              <li>Outputs may reflect biases or errors from underlying models</li>
              <li>Responses are generated automatically and are not reviewed by humans</li>
            </ul>
            <p className="mt-4 font-bold">The Service is provided for informational purposes only. You must not rely on it for:</p>
            ...
            <p className="mt-4">You are solely responsible for how you use the generated content.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4 text-slate-900">8. Data and Chats</h2>
            <ul className="list-disc ml-6 space-y-2 text-slate-800">
              ...
              <li>Once deleted, chats are permanently removed from our systems</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">We are not responsible for their services, availability, or performance.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4 text-slate-900">10. No Cookies Usage</h2>
            <p>We do not use cookies for tracking or storing personal data.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4 text-slate-900">11. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-slate-900">12. Termination</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4 text-slate-900">13. Changes to Terms</h2>
          ...
          <section className="pb-10">
            ...
            <p>For any questions, contact us at: <a href="mailto:support@gptiti.com" className="font-bold text-blue-600 hover:underline">support@gptiti.com</a></p>
          </section>
        </div>
      </main>
    </div>
