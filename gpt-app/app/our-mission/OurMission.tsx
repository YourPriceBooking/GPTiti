    ...
    <section className="min-h-screen bg-white flex flex-col items-center justify-center p-6">
      ...
      >
        ...
        >
          ...
          but exactly until you use them. This is how access to knowledge should
          work: fair, transparent, and empowering.
        </motion.p>
        ...
        >
          ...
          students, creators, researchers, entrepreneurs, dreamers — the chance
          to leverage the world’s smartest AI tools without limits. When people
          have equal access to intelligence, the entire world moves forward.
        </motion.p>
        ...
        <motion.p
          ...
          transition={{ duration: 0.7, ease: "easeOut" }}
        >
          GPtiti exists because we believe in a future where advanced AI is not
          locked behind paywalls, but shared freely for the benefit of humanity.
        </motion.p>
      </motion.section>
    </section>
  );
