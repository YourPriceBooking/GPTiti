  ...
  return (
    <div className={styles.mainSectionContainer}>
        {!hidden ? (<section className={styles.additionalSectionContainer}>
            ...
            <h1 className={styles.additionalSectionTitle}>What do you want to do today?</h1>
            <span className={styles.additionalSectionSpan2}>Pick a quick action or type your request below.</span>
            <section className={styles.infoContainer}>
                <article className={styles.infoContainerCard}  onClick={() => insertTemplate("Summarize the following text into clear bullet points:")}>
                    <div className={styles.CardIconContainer}>
                        <Image src = 'icons/summarize.svg' width={24} height={24} alt='summar'/>
                    </div>
                    <div className={styles.CardTextInfoContainer}>
                        <p className={styles.CardParapgraph}>Summarize</p>
                        <span className={styles.CardSpan}>Paste text → get a clean summary.</span>
                    </div>
                </article>
                <article className={styles.infoContainerCard} onClick = {() => insertTemplate("Rewrite this to sound clearer and more professional (keep the meaning):")}>
                    <div className={styles.CardIconContainer}>
                        <Image src = 'icons/write.svg' width={24} height={24} alt='write'/>
                    </div>
                    <div className={styles.CardTextInfoContainer}>
                        <p className={styles.CardParapgraph}>Write / Improve</p>
                        <span className={styles.CardSpan}>Rewrite, fix tone, make it clearer.</span>
                    </div>
                </article>
                <article className={styles.infoContainerCard} onClick = {() => insertTemplate("Translate this to English. Keep the tone and formatting:")}>
                    <div className={styles.CardIconContainer}>
                        <Image src = 'icons/translate.svg' width={24} height={24} alt='translate'/>
                    </div>
                    <div className={styles.CardTextInfoContainer}>
                        <p className={styles.CardParapgraph}>Translate</p>
                        <span className={styles.CardSpan}>Any language, preserving meaning.</span>
                    </div>
                </article>
                <article className={styles.infoContainerCard} onClick = {() => insertTemplate("Create a step-by-step plan for this goal. Include time estimates and a checklist:")}>
                    <div className={styles.CardIconContainer}>
                        <Image src = 'icons/plan.svg' width={24} height={24} alt='plan'/>
                    </div>
                    <div className={styles.CardTextInfoContainer}>
                        <p className={styles.CardParapgraph}>Plan</p>
                        <span className={styles.CardSpan}>Steps, checklist, timeline.</span>
                    </div>
                </article>
                <article className={styles.infoContainerCard} onClick = {() => insertTemplate("Help me debug this. Explain the cause and suggest a fix:")}>
                    <div className={styles.CardIconContainer}>
                        <Image src = 'icons/code-helper.svg' width={24} height={24} alt='code-helper'/>
                    </div>
                    <div className={styles.CardTextInfoContainer}>
                        <p className={styles.CardParapgraph}>Code helper</p>
                        <span className={styles.CardSpan}>Explain, debug, generate code.</span>
                    </div>
                </article>
                <article className={styles.infoContainerCard} onClick = {() => insertTemplate("Give me 15 creative ideas for:")}>
                        <div className={styles.CardIconContainer}>
                        <Image src = 'icons/brain-storm.svg' width={24} height={24} alt='brain-storm'/>
                    </div>
                    <div className={styles.CardTextInfoContainer}>
