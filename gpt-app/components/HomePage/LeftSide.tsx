      ...
      <g className="ghost">
        ...
        <footer>
          <ul className={styles.footerList}>
            <li className={styles.footerItem}><Link href='/' className="hover:text-gray-700">Home</Link></li>
            <li className={styles.footerItem}><Link href='/our-mission' className="hover:text-gray-700">Our Mission</Link></li>
            <li className={styles.footerItem}><Link href='/sign-in' className="hover:text-gray-700">Sign in</Link></li>
            </ul>
            <ul className={styles.footerList1}>
            <li className={styles.footerItem}><Link href='/terms-conditions' className="hover:text-gray-700">Terms & Conditions</Link></li>
            <li className={styles.footerItem}> <Link href='/privacy-policy' className="hover:text-gray-700">Privacy Policy</Link></li>
           </ul>
