...
export default function DeleteModalWindow({ onCancel, onConfirm }: DeleteModalWindowProps) {
  return (
    <div className={styles.container}>
        ...
        <h2 className={styles.title}>Delete this chat?</h2>
        <p className={styles.paragraph}>This action can’t be undone.</p>
        <p className={styles.paragraph}>The chat will be permanently removed.</p>
